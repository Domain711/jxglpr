<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item label="课程" prop="papertype">
          <el-select v-model="dataForm.papertype" placeholder="请选择课程">
            <el-option
  ...
  export default {
    ...
    methods: {
      init (id) {
        ...
        API.course.select().then(({data}) => {
          this.courseList = data && data.code === 0 ? data.courseList : []
        }).then(() => {
          this.visible = true
          this.$nextTick(() => {
